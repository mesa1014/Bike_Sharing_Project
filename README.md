...
# Bike Sharing Project (A neural network implementation from scratch using only NumPy)
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f8bc0f787f0>
...
```
    ...
    Progress: 100.0% ... Training loss: 0.096 ... Validation loss: 0.180
...
ax.plot(predictions[0]*std + mean, label='Prediction')
